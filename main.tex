...
%the above paragraph makes me think that the whitepaper will address other issues in d&i. did we want to expand the scope at some point, or keep it focused on one topic? If I understood the discussion at the meeting today, there will be multiple whitepapers coming from the d&i TG, so i think it is fine to just focus on this
